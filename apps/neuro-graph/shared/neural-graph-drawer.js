/**
 * Shared mobile drawer for neural graph pages.
...
(function() {
    ...
    var html =
        ...
        '<div id="bottomDrawer" class="bottom-drawer drawer-level-0" role="dialog" aria-label="Node details">' +
        '  <div class="drawer-header">' +
        '    <div class="drawer-handle" aria-hidden="true"></div>' +
        '  </div>' +
        '  <div id="drawerContent" class="drawer-content">' +
        '    <div class="drawer-section drawer-selected-node-section">' +
        '      <div id="drawerDetails" class="drawer-details-inner"><p class="drawer-detail-desc" style="color: rgba(255,255,255,0.6);">Select a node on the graph to see details.</p></div>' +
        '    </div>' +
        ...
        '    </div>' +
        '    <div class="drawer-section drawer-actions-section">' +
